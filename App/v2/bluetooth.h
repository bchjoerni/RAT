...
const QString DEFAULT_DEVICE_NAME = "RAT_v2";
const QString DEFAULT_ADRESS      = "98:D3:31:30:3E:84";
const QString DEFAULT_UUID        = "00001101-0000-1000-8000-00805F9B34FB";
const QString SEND_CMD            = "startDef\r\n";
const QString STOP_CMD            = "stop\r\n";
const QString KEEPSENDING_CMD     = "on\r\n";
...
private:
    ...
    QTimer _demoTimer;
    int _demoCounter;
    QTimer _keepSendingTimer;

    const int _sendSendCmdIntervalMs = 1000;
};
